...
class DatabaseSeeder extends Seeder {
    ...
    public function run() {
        ...
        DB::table('appartamento')->insert([
			...
			['id_annuncio' => 6, 'numero_camere' => 2, 'dimensioni_appartamento' => 90, 'presenza_cucina' => true, 'presenza_locale_ricreativo' => false, 'tipologia' => 'appartamento'],
			['id_annuncio' => 9, 'numero_camere' => 2, 'dimensioni_appartamento' => 100, 'presenza_cucina' => true, 'presenza_locale_ricreativo' => true, 'tipologia' => 'appartamento'],
			['id_annuncio' => 10, 'numero_camere' => 4, 'dimensioni_appartamento' => 120, 'presenza_cucina' => true, 'presenza_locale_ricreativo' => true, 'tipologia' => 'appartamento'],
			['id_annuncio' => 12, 'numero_camere' => 3, 'dimensioni_appartamento' => 90, 'presenza_cucina' => false, 'presenza_locale_ricreativo' =>false, 'tipologia' => 'appartamento']
        ]);
        ...
        DB::table('posto_letto')->insert([
			...
			['id_annuncio' => 5, 'dimensioni_camera' => 18, 'letti_nella_camera' => 1, 'presenza_angolo_studio' => true, 'tipologia' => 'singola'],
			['id_annuncio' => 7, 'dimensioni_camera' => 20, 'letti_nella_camera' => 2, 'presenza_angolo_studio' => false, 'tipologia' => 'condivisa'],
			['id_annuncio' => 8, 'dimensioni_camera' => 18, 'letti_nella_camera' => 2, 'presenza_angolo_studio' =>false, 'tipologia' => 'condivisa'],
			['id_annuncio' => 11, 'dimensioni_camera' => 30, 'letti_nella_camera' => 2, 'presenza_angolo_studio' =>true, 'tipologia' => 'condivisa'],
			['id_annuncio' => 13, 'dimensioni_camera' => 30, 'letti_nella_camera' => 2, 'presenza_angolo_studio' =>false, 'tipologia' => 'condivisa']
        ]);
        ...
        DB::table('messaggio')->insert([
			...
			['username_locatore' => 'lorelore', 'username_locatario' => 'lariolario', 'data_invio' => '2022-06-06 15:00:00', 'testo' => 'Salve, sarei interessato all\'annuncio sulla camera singola.', 'mittente' => 'lariolario'],
			['username_locatore' => 'giovanna', 'username_locatario' => 'lariolario', 'data_invio' => '2022-06-07 18:00:00', 'testo' => 'Salve, sarei interessato all\'annuncio sull\'appartamento.', 'mittente' => 'lariolario'],
			['username_locatore' => 'lorelore', 'username_locatario' => 'luca', 'data_invio' => '2022-06-11 15:01:59', 'testo' => 'Salve, sarei interessato all\'annuncio sull\'appartamento.', 'mittente' => 'lariolario'],
			['username_locatore' => 'lorelore', 'username_locatario' => 'noemi', 'data_invio' => '2022-06-11 17:00:00', 'testo' => 'Salve, sarei interessato all\'annuncio sul posto letto.', 'mittente' => 'lariolario'],
			['username_locatore' => 'mario', 'username_locatario' => 'lariolario', 'data_invio' => '2022-06-11 20:02:31', 'testo' => 'Salve, sarei interessato all\'annuncio sulla camera condivisa.', 'mittente' => 'lariolario'],
		]);
