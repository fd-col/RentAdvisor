      ...
      <div class="aa-top-slider">
        ...
        <div class="aa-top-slider-single">
          ...
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Milano</span>
            <h2 class="aa-top-slider-title">A caso</h2>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>vista grattacieli, Milano</p>
            <span class="aa-top-slider-off">30% OFF</span>
            <p class="aa-top-slider-price">1000 case in affitto</p>
          </div>
          <!-- / Top slider content -->
        </div>
        <!-- / Top slider single slide -->
        ...
        <div class="aa-top-slider-single">
          ...
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Bologna</span>
            <h2 class="aa-top-slider-title">Piazza ...</h2>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>Piazza ..., Bologna</p>
            <span class="aa-top-slider-off">30% OFF</span>
            <p class="aa-top-slider-price">1000 case in affitto</p>
          </div>
          <!-- / Top slider content -->
        ...
        <div class="aa-top-slider-single">
          ...
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Ancona</span>
            <h2 class="aa-top-slider-title">Passetto</h2>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>Passetto, Ancona</p>
            <span class="aa-top-slider-off">30% OFF</span>
            <p class="aa-top-slider-price">1000 case in affitto</p>
          </div>
          <!-- / Top slider content -->
        ...
        <div class="aa-top-slider-single">
          ...
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Lecce</span>
            <h2 class="aa-top-slider-title">Piazza Sant'Oronzo</h2>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>Piazza Sant'Oronzo, Lecce</p>
            <span class="aa-top-slider-off">30% OFF</span>
            <p class="aa-top-slider-price">1000 case in affitto</p>
          </div>
          <!-- / Top slider content -->
        ...
        <div class="aa-top-slider-single">
          ...
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Pescara</span>
            <h2 class="aa-top-slider-title">Città portuale</h2>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>vista dall'alto, Pescara</p>
            <span class="aa-top-slider-off">30% OFF</span>
            <p class="aa-top-slider-price">1000 case in affitto</p>
          </div>
          <!-- / Top slider content -->
        ...
        <div class="aa-top-slider-single">
          ...
          <!-- Top slider content -->
          <div class="aa-top-slider-content">
            <span class="aa-top-slider-catg">Roma</span>
            <h2 class="aa-top-slider-title">Centro città</h2>
            <p class="aa-top-slider-location"><i class="fa fa-map-marker"></i>San Pietro, Roma</p>
            <span class="aa-top-slider-off">30% OFF</span>
            <p class="aa-top-slider-price">1000 case in affitto</p>
          </div>
          <!-- / Top slider content -->
